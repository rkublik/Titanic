...
```
 ...
 ### Cabin - move this to the predictive analytics part...
Since there are `r missing_vals['cabin']` missing cabin values (out of `r nrow(titanic_data)`) entries, we will simply drop the cabin column.
